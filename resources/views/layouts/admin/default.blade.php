            ...
            <div class="row text-center align-items-center flex-row-reverse">
              <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                  ...
                  <li class="list-inline-item"><a href="https://github.com/nitishdola" target="_blank" class="link-secondary" rel="noopener">Developer Profile</a></li>
              ...
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">
                    Copyright &copy; 2022
                    <a href="." class="link-secondary">AAAS</a>.
                    All rights reserved.
                  </li>
                  <li class="list-inline-item">
